    ...
    <header className="fixed top-0 left-0 w-full bg-surface/80 backdrop-blur-xl z-50 shadow-md">
      <nav className="flex justify-between items-center px-8 py-6 max-w-7xl mx-auto">
        ...
        <div className="flex-shrink-0 lg:w-1/4">
          <Link
            to="/"
            className="text-2xl font-bold text-tertiary tracking-tighter font-headline flex items-center"
          >
            <img
              src={logoImg}
              alt="SENADA Logo"
        ...
        <div className="hidden md:flex flex-grow justify-center items-center gap-8 font-semibold text-sm font-headline">
          ...
          <Link
            to="/articles"
            className={
              location.pathname === "/articles" ? activeClass : inactiveClass
            }
          >
            Artikel
          </Link>
          <Link
            ...
            className={
              location.pathname === "/activities" ? activeClass : inactiveClass
            }
          >
            Aktivitas
          </Link>
            ...
            >
              ...
              <div className="text-left leading-tight">
                ...
                <p className="text-[11px] font-bold text-primary whitespace-nowrap">
                  {prayerTimes ? getNextPrayer(prayerTimes) : "Memuat..."}
                </p>
              </div>
            </button>
          </div>
